...
ggplot(data = seasons_avg, aes(x = reorder(season, -season), y = avg_rating)) + 
  ...
  annotate("text", x = 9, y = 1, label = "Season 1") + 
  annotate("text", x = 8, y = 1, label = "Season 2") +
  annotate("text", x = 7, y = 1, label = "Season 3") +
  annotate("text", x = 6, y = 1, label = "Season 4") +
  annotate("text", x = 5, y = 1, label = "Season 5") +
  annotate("text", x = 4, y = 1, label = "Season 6") +
  annotate("text", x = 3, y = 1, label = "Season 7") +
  annotate("text", x = 2, y = 1, label = "Season 8") +
  annotate("text", x = 1, y = 1, label = "Season 9") +
  coord_flip()
